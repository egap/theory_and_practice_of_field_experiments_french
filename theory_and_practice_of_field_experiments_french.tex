...
\usepackage{hyperref}
\hypersetup{
            pdfauthor={Jake Bowers, Maarten Voors, et Nahomi Ichino \textbar{} Traduit par Alyssa Heinze \textbar{} (Original in English) \textbar{} (Traducción en español) por Lily Medina},
            colorlinks=true,
            linkcolor=Maroon,
            filecolor=Maroon,
            citecolor=Blue,
...
\author{Jake Bowers,\footnote{L'ordre des noms d'auteurs est généré de manière aléatoire. \url{https://jakebowers.org}} Maarten Voors,\footnote{\url{https://sites.google.com/site/maartenvoors/}} et Nahomi Ichino\footnote{\url{https://nahomi.github.io/}} \textbar{} Traduit par Alyssa Heinze\footnote{\url{https://alyssaheinze.github.io/}} \textbar{} (\href{https://egap.github.io/theory_and_practice_of_field_experiments/}{Original in English}) \textbar{} (\href{https://egap.github.io/theory_and_practice_of_field_experiments_spanish/}{Traducción en español}) por Lily Medina\footnote{\url{https://lilymedina.github.io/}}}
\date{02-03-2022}
