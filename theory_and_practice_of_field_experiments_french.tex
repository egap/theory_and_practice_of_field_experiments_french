...
\usepackage{hyperref}
\hypersetup{
            pdfauthor={Jake Bowers, Maarten Voors, et Nahomi Ichino.  Traduit par Alyssa Heinze},
            colorlinks=true,
            linkcolor=Maroon,
            filecolor=Maroon,
            citecolor=Blue,
...
\author{Jake Bowers,\footnote{L'ordre des noms d'auteurs est généré de manière aléatoire. \url{https://jakebowers.org}} Maarten Voors,\footnote{\url{https://sites.google.com/site/maartenvoors/}} et Nahomi Ichino\footnote{\url{https://nahomi.github.io/}}. Traduit par Alyssa Heinze\footnote{\url{https://alyssaheinze.github.io/}}}
\date{01-03-2022}
