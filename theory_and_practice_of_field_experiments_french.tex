...
\usepackage{hyperref}
\hypersetup{
            pdfauthor={Jake Bowers,. https://jakebowers.org{]} Maarten Voors, et Nahomi Ichino},
            colorlinks=true,
            linkcolor=Maroon,
            filecolor=Maroon,
            citecolor=Blue,
...
Une introduction des Learning Days de EGAP}
...
Durant la dernière décennie, \href{http://egap.org/}{Evidence in Governance and Politics (EGAP)} a organisé une série de TODO workshops, \href{https://egap.org/learning-days/}{Learning Days}, dans le but de renforcer la capacité de recherche expérimentale en sciences sociales parmi les TODO principal investigators (PIs) -- des cheurcheurs et TODO praticiens -- en Afrique et Amérique Latine. En partageant les méthodes pratiques et statistiques des expériences de terrain TODO aléatoires avec les participants aux TODO workshops, l'initiative des Learning Days vise à identifier et à entretenir des réseaux de chercheurs dans le monde entier et à créer des liens solides et productifs entre ces chercheurs et les membres de EGAP.
...
You can copy this book or parts thereof (e.g., slides, etc.) either by using the Download button on the front page of \url{http://github.com/egap/theory_and_practice_of_field_experiments_french} or by using github directly (by forking this repository).
...
If you have any questions, feedback or have organized your own event, please get in touch! Simply post an issue on \href{https://github.com/egap/theory_and_practice_of_field_experiments_french/issues}{Github} or make comments using hypothes.is in your browser and let us know via email, \href{mailto:admin@egap.org}{\nolinkurl{admin@egap.org}}. We'll periodically go through the comments.
...
Ci-dessous voici les termes principaux, frequemment utilisés dans le livre et plus generalement a travers les dicussions de randomized field experiments.
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{/home/runner/work/theory_and_practice_of_field_experiments_french/theory_and_practice_of_field_experiments_french/Book/Images/new_rstudio} \caption{Select Download in the "RStudio Desktop Open Source License" column.}\label{fig:rstudiopng}
\end{figure}
