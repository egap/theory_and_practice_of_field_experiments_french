...
Ce livre comprend des \textbf{slides} sur le contenu principal, le \href{researchdesignform.html}{formulaire de conception de recherche de EGAP} et des \textbf{références} d'exemples de recherche et des slides utilisées pendant les journées d'apprentissage précédentes. Ces matériaux renforcent le travail de EGAP sur la méthodologie, résumé dans les \href{https://egap.org/methods-guides/}{guides de méthodes de EGAP}. Comparé aux journées d'apprentissage précédentes, nous avons ajouté plus de matériaux sur les tests d'hypothèses, l'estimation et la puissance statistique. De nouveaux modules sur le processus de conception de recherche, la mesure et les considérations éthiques sont désormais disponibles. Les slides et les modules présentés ici contiennent trop d'informations pour être couverts en une seule semaine, la durée habituelle d'un atelier. Cependant, nous avons décidé de conserver toutes les informations, afin d'aider les instructeurs à adapter leurs cours à leurs publics respectifs.
...
Vous pouvez copier ce livre ou des parties de celui-ci (des slides, etc.) soit en utilisant le bouton de téléchargement (Download) sur la première page de \url{https://github.com/egap/theory_and_practice_of_field_experiments_french}, soit directement sur github en ``forkant'' ce répertoire.
...
\item
  ...
  \begin{itemize}
  \item
    SMS au Mozambique par le \href{https://oes.gsa.gov/projects/sms-mozambique/}{gouvernement fédéral américain}
  \item
...
\begin{itemize}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-les-plans-de-pre-analyse/}{10 choses à savoir sur les plans de pré-analyse}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-la-mesure-dans-les-experiences/}{10 choses à savoir sur la mesure dans les expériences}
\end{itemize}
...
\item
  \autocite{gerber_field_2012}. Le chapitre 12 comprend quelques exemples de conceptions de recherche expérimentale.
\end{itemize}
...
\item
  Votre question causale est liée à votre \href{processus-de-conception-de-recherche.html}{conception de recherche}.
\end{itemize}
...
\begin{itemize}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-linference-causale/}{10 choses à savoir sur l'inférence causale}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-strategies-pour-determiner-si-x-cause-y/}{10 stratégies pour déterminer si X a causé Y}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-sur-les-mecanismes/}{10 choses à savoir sur les mécanismes}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-la-validite-externe/}{10 choses à savoir sur la validité externe}
\end{itemize}
...
Le module sur \href{inférence-causale.html}{l'inférence causale} aborde le rôle important de la randomisation pour tirer des inférences valides à partir d'une comparaison des groupes traités et non traités. Dans ce module, nous passons de la théorie aux cas concrets pour votre conception de recherche.
...
\item
  La randomisation a \textbf{des limites}. Nous en discutons ici et nous vous orientons vers le module sur \href{menaces-affectant-la-validité-interne-des-expériences-aléatoires.html}{les menaces} pour en savoir plus.
\end{itemize}
...
\begin{itemize}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-la-randomisation/}{10 choses à savoir sur la randomisation}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-la-randomisation-par-grappe/}{10 choses à savoir sur la randomisation par grappe (cluster)}
\end{itemize}
...
Ce n'est pas possible d'observer directement les effets causaux à cause du \emph{problème fondamental de l'inférence causale} (\href{inférence-causale.html}{module de l'inférence causale}).
...
\item
  Comment saurons-nous si notre test d'hypothèse performe bien ? (Se référer au \href{puissance-statistique-et-diagnostics-de-conception.html}{module d'analyse de puissance statistique}).
...
\begin{itemize}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-les-tests-dhypotheses/}{10 choses à savoir sur les tests d'hypothèses}
\item
  Guide des méthodes EGAP \href{https://egap.org/resource/10-things-to-know-about-multiple-comparisons/}{10 choses à savoir sur les comparaisons multiples} (en anglais)
\end{itemize}
...
\item
  \href{https://egap.github.io/learningdays-resources/Slides/Examples/threats-benin.pdf}{Présentation des problèmes de conception aux journées d'apprentissage du réseau EGAP à l'African School of Economics, Abomey-Calavi, juin 2019 (la première section passe en revue les conceptions de randomisation)}
\item
  \href{https://egap.github.io/learningdays-resources/Slides/Examples/spillovers_attrition-guatemala.pdf}{Présentation des effets de contamination et de l'attrition aux journées d'apprentissage du réseau EGAP à Guatemala City, Guatemala, août 2017}
\item
...
\begin{itemize}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-types-deffets-de-traitement-a-connaitre/}{Les 10 types d'effets de traitement à connaître}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-lajustement-des-covariables/}{10 choses à savoir sur l'ajustement de covariable}
\item
  Guide des méthodes EGAP \href{https://egap.org/resource/10-things-to-know-about-missing-data/}{10 choses à savoir sur les données manquantes} (en anglais)
\item
  Guide des méthodes EGAP \href{https://egap.org/resource/10-things-to-know-about-the-local-average-treatment-effect/}{10 choses à savoir sur l'effet moyen local du traitement} (en anglais)
\item
  Guide des méthodes EGAP \href{https://egap.org/resource/10-things-to-know-about-spillovers/}{10 choses à savoir sur les effets de contamination} (en anglais)
\end{itemize}
...
\item
  La puissance statistique est étroitement liée à \href{processus-de-conception-de-recherche.html}{la conception de l'étude}, aux \href{tests-dhypothèses.html}{tests d'hypothèses} et à \href{paramètres-et-estimateurs.html}{l'estimation}.
\end{itemize}
...
\begin{itemize}
\item
  \href{https://egap.github.io/learningdays-resources/Slides_fr/power-slides.Rmd}{Code source en R Markdown}
\item
  \href{https://egap.github.io/learningdays-resources/Slides_fr/power-slides.pdf}{Version PDF}
\item
  \href{https://egap.github.io/learningdays-resources/Slides_fr/power-slides.html}{Version HTML}
\end{itemize}
...
\begin{itemize}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-la-puissance-statistique/}{10 choses à savoir sur la puissance statistique}
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-lajustement-des-covariables/}{10 choses à savoir sur l'ajustement des covariables}
\item
  Guide des méthodes EGAP \href{https://egap.org/resource/10-things-your-null-result-might-mean/}{10 choses que vos résulats nuls peuvent signifier} (en anglais)
\end{itemize}
...
Ce module traite \emph{que mesurer} et \emph{comment mesurer}. Il montre à quel point une bonne mesure est liée à la \href{https://egap.github.io/learningdays-resources/Exercises/design-form.Rmd}{conception de recherche} et à la \href{puissance-statistique-et-diagnostics-de-conception.html}{puissance statistique}.
...
\item
  Une mesure non fiable peut diminuer \href{puissance-statistique-et-diagnostics-de-conception.html}{la puissance statistique}.
\item
...
\item
  Guide des méthodes EGAP \href{https://egap.org/fr/resource/10-choses-a-savoir-sur-la-mesure-dans-les-experiences/}{10 choses à savoir sur la mesure dans les expériences}
\item
  Guide des méthodes EGAP \href{https://egap.org/resource/10-things-to-know-about-survey-design/}{10 choses à savoir sur la conception de sondage} (en anglais)
\item
  Guide des méthodes EGAP \href{https://egap.org/resource/10-things-to-know-about-survey-implementation/}{10 choses à savoir sur l'implémentation de sondage} (en anglais)
\end{itemize}
...
\begin{itemize}
\item
  \href{https://egap.org/resource/brief-16-spillover-effects-of-observers-in-ghana/}{Note d'orientation des politiques publiques EGAP 16 : Effets de contamination des observateurs électoraux au Ghana}
\item
...
\item
  ...
  \end{itemize}
\item
  \textbf{Les ``effets de contamination'' ou les interférences entre unités} constituent une violation de l'une des hypothèses fondamentales de l'\href{inférence-causale.html}{inférence causale}.
...
\item
  \href{https://egap.org/resource/brief-16-spillover-effects-of-observers-in-ghana/}{Note d'orientation EGAP 16 : Effets de contamination des observateurs électoraux au Ghana}
\end{itemize}
...
\item
  ...
  Voir le module sur \href{inférence-causale.html}{l'inférence causale} et le module sur les \href{paramètres-et-estimateurs.html}{paramètres et estimateurs}.
\item
...
\item
  ...
  (y compris le contrôle). Voir le module sur \href{randomisation.html}{la randomisation}.
\item
  ...
  Voir le module sur \href{randomisation.html}{la randomisation}.
\item
...
Voir les modules sur \href{tests-dhypothèses.html}{les tests d'hypothèses} et \href{puissance-statistique-et-diagnostics-de-conception.html}{la puissance statistique}.
...
Voir le module sur les \href{menaces-affectant-la-validité-interne-des-expériences-aléatoires.html}{menaces}.

\begin{itemize}
\item
  \textbf{Effet Hawthorne} lorsqu'un sujet réagit différemment quand il est observé.
\item
  \textbf{Effet de contamination} lorsqu'un sujet répond au statut de traitement d'un autre sujet.
...
\begin{figure}
\includegraphics[width=0.8\linewidth]{/home/runner/work/theory_and_practice_of_field_experiments_french/theory_and_practice_of_field_experiments_french/Book/Images/new_rstudio} \caption{Sélectionner "Download" dans la colonne "RStudio Desktop Open Source License".}\label{fig:rstudiopng}
\end{figure}
