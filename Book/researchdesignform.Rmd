...
- [Code source en R Markdown](https://egap.github.io/learningdays-resources/Slides_fr/researchdesignform-slides.Rmd)

- [Version PDF](https://egap.github.io/learningdays-resources/Slides_fr/researchdesignform-slides.pdf)

- [Version HTML](https://egap.github.io/learningdays-resources/Slides_fr/researchdesignform-slides.html)
...
- Exemples d'autres pré-enregistrements/plans de pré-analyse :
    ...
    - SMS au Mozambique par le [gouvernement fédéral américain](https://oes.gsa.gov/projects/sms-mozambique/)
...
- Guide des méthodes EGAP [10 choses à savoir sur les plans de pré-analyse](https://egap.org/fr/resource/10-choses-a-savoir-sur-les-plans-de-pre-analyse/)
...
- [@gerber_field_2012].  Le chapitre 12 comprend quelques exemples de conceptions de recherche expérimentale.
