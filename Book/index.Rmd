...
description: "Les Learning Days de EGAP, causal inference, randomized experiments, expériences de terrain, experimental design, research design"
fontsize: 12pt
geometry: margin=1in
graphics: yes
clean: no
...
You can copy this book or parts thereof (e.g., slides, etc.) either by using the Download button on the front page of <http://github.com/egap/theory_and_practice_of_field_experiments_french> or by using github directly (by forking this repository).
