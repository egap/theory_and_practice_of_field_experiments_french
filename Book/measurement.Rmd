...
Ce module traite *que mesurer* et *comment mesurer*. Il montre à quel point une bonne mesure est liée au [design de recherche](https://egap.github.io/learningdays-resources/Exercises/design-form.Rmd) et à la [puissance statistique](statistical-power-and-design-diagnosands.html).
...
- Guide des méthodes EGAP [10 choses à savoir sur le design de sondage](https://egap.org/resource/10-things-to-know-about-survey-design/)
