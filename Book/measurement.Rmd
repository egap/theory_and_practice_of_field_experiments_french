...
Ce module traite *que mesurer* et *comment mesurer*. Il montre à quel point une bonne mesure est étroitement liée à vos [designs de recherche](https://egap.github.io/learningdays-resources/Exercises/design-form.Rmd) et [puissance statistique](statistical-power-and-design-diagnosands.html).
...
## Contenu
 ...
 - Pour votre [design de recherche](https://egap.github.io/learningdays-resources/Exercises/design-form.Rmd), une mesure invalide peut rendre difficile la distinction efficace des explications alternatives de la relation entre le traitement et les résultats.
...
- Guide des méthodes EGAP [10 choses à savoir sur le design de questionaire](https://egap.org/resource/10-things-to-know-about-survey-design/)

- Guide des méthodes EGAP [10 choses à savoir sur l'implémentation de questionnaire](https://egap.org/resource/10-things-to-know-about-survey-implementation/)
