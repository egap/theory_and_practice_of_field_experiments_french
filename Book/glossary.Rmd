...
- **Hypothèse nulle forte d'absence d'effet** L'hypothèse nulle selon laquelle il n'y a aucun effet du traitement pour aucun sujet.
...
- **Cohérence d'un estimateur** Un estimateur qui produit des réponses qui se rapprochent de plus en plus de la vraie valeur de l'estimande à mesure que la taille de l'échantillon augmente est un *estimateur cohérent* de cette estimation. Un estimateur cohérent peut être sans biais ou non.
  Voir le module sur les [estimandes et estimateurs](estimands-and-estimateurs.html).
