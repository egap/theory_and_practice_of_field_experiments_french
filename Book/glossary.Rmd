...
- **Erreur standard (erreur type)** L'écart type de la distribution d'échantillonnage. Une erreur standard plus élevée signifie que nos estimations sont plus sensibles aux variations d'échantillonnage.
