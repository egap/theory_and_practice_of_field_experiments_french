...
- **Complète** Assigner $m$ sur $N$ unités au traitement. Vous savez combien d'unités seront traitées dans votre expérience et chaque unité a une probabilité de $m/N$ d'être traitée. Le nombre de façons dont le traitement peut être affecté (nombre de permutations d'assignation de traitement) est $\frac{N!}{m!(N-m)!}$.
...
- **Types de conformité** Il existe quatre types d'unités en termes de conformité :
     ...
     - **Jamais preneurs** Unités qui ne seraient pas traitées si elles étaient affectées au traitement et si elles étaient affectées au contrôle.
