...
- Guide des méthodes EGAP [10 choses à savoir sur l'inférence causale](https://egap.org/fr/resource/10-choses-a-savoir-sur-linference-causale/)

- Guide des méthodes EGAP [10 stratégies pour déterminer si X a causé Y](https://egap.org/fr/resource/10-strategies-pour-determiner-si-x-cause-y/)

- Guide des méthodes EGAP [10 choses à savoir sur les mécanismes](https://egap.org/fr/resource/10-choses-sur-les-mecanismes/)

- Guide des méthodes EGAP [10 choses à savoir sur la validité externe](https://egap.org/fr/resource/10-choses-a-savoir-sur-la-validite-externe/)
