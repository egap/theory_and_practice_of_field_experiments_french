...
\item
  \textbf{Grappe (Cluster)} Les grappes d'unités sont assignés de manière aléatoire à une condition de traitement. Un cluster est un ensemble d'unités qui sera toujours assigné au même statut de traitement.
\item
