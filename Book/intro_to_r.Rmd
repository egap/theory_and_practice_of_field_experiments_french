...
Une fois qu'un paquet est installé, il peut être chargé et accessible en utilisant `library()` où le nom du paquet est inséré entre parenthèses (sans guillemets).
