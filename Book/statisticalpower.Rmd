...
### Guide des méthodes EGAP
 ...
 - Guide des méthodes EGAP [10 choses à savoir sur la puissance statistique](https://egap.org/fr/resource/10-choses-a-savoir-sur-la-puissance-statistique/)

 - Guide des méthodes EGAP [10 choses à savoir sur l'ajustement des covariables](https://egap.org/fr/resource/10-choses-a-savoir-sur-lajustement-des-covariables/)
 
 - Guide des méthodes EGAP [10 choses que vos résulats nuls peuvent signifier](https://egap.org/resource/10-things-your-null-result-might-mean/) (en anglais)
