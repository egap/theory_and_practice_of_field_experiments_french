...
## Contenu {.tabset}
 ...
 - Nous avons dit "analysez en randomisant" dans le module sur les [paramètres et estimateurs](estimands-and-estimators.html). N'oubliez pas que vous avez randomisé **l'assignation** du traitement. Vous n'avez pas randomisé si le traitement est reçu, ni si une unité participe à la collecte de données.
