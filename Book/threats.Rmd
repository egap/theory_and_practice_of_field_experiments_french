...
## Contenu {.tabset}
 ...
 - **Les données manquantes dans les résultats (i.e. l'attrition)** sont particulièrement problèmatiques si le pattern des données absentes est causé par le traitement lui-même. C'est un problème très courant.
